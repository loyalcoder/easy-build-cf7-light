...
class Input_Textarea extends Widget_Base
{
    ...
    {
        return 'easy-build-cf7-input-textarea';
    }
/**
    ...
    {
        return esc_html__('Input Text Area', 'easy-build-cf7-light');
    }
/**
     * Get widget icon.
     *
    ...
    {
        return ['input', 'textarea', 'field', 'easy-build-cf7'];
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Type Your Message', 'easy-build-cf7-light'),
                'condition' => [
                    'show_label' => 'yes',
                ],
            ]
    ...
    $this->add_control(
        ...
        [
            ...
            'options' => [
                ...
                'justify' => [
                    'title' => esc_html__('Justify', 'easy-build-cf7-light'),
