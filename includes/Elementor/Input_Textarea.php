...
class Input_Textarea extends Widget_Base
{
    public function get_name()
    {
        return 'builder-7-input-textarea';
    }
/**
    ...
    {
        return esc_html__('Input Text Area', 'builder7');
    }
/**
     * Get widget icon.
     *
    ...
    {
        return ['input', 'textarea', 'field', 'builder-7'];
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'textarea-' . wp_rand(100, 999),
            ]
        );
        $this->add_control(
            'is_required',
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Type Your Message', 'builder7'),
                'condition' => [
                    'show_label' => 'yes',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Use Default Value as Placeholder', 'builder7' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'builder7' ),
                'label_off' => esc_html__( 'No', 'builder7' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Placeholder Color', 'builder7'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    $this->add_control(
        ...
        [
            ...
            'options' => [
                ...
                'justify' => [
                    'title' => esc_html__('Justify', 'builder7'),
    ...
    protected function render()
    {
        ...
        $attributes['class']      = 'cf7-e-addon lcf7-form-control b7-textarea';
        ...
        if($settings['default_value_as_placeholder']){
            $fr_placeholder = ' placeholder='.$settings['default_value'];
        }
        if(!$settings['default_value_as_placeholder']){
            $fr_value = $settings['default_value'];
        }
        if($settings['default_value_as_placeholder']){
