 ...
 /**
    ...
    protected function register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .l-cf7-field-parent > input, {{WRAPPER}} .lcf7-form-control' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'selectors' => easy_build_cf7_light_input_width_selectors(['.lcf7-form-control', '.b7-form-control']),
        ]
    );
