jQuery(function($){
    ...
    $(document).on('submit', '.crete-post', function(e){
        ...
        formData.append('nonce', builder7Ajax.nonce);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    let link = '<a href="'+response.data.edit_url+'">Edit With Elementor</a>';
                    $('.edit-with-elementor').html(link);
                } else {
